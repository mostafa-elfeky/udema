	...
	<div id="page">
		...
		<div class="filters_listing sticky_horizontal">
			<form:form method="get"
				...
				<form:input type="hidden" path="keyword"></form:input>
				<div class="container">
					<ul class="clearfix">
						<li>
							<div class="switch-field">
								<form:radiobutton id="all" path="listingType" value="ALL"
									onchange="this.form.submit()" />
								<label for="all">All</label>
								<form:radiobutton id="popular" path="listingType"
									value="POPULAR" onchange="this.form.submit()" />
								<label for="popular">Popular</label>
								<form:radiobutton id="latest" path="listingType" value="LATEST"
									onchange="this.form.submit()" />
								<label for="latest">Latest</label>
							</div>
						</li>
						<li><form:select path="category" class="selectbox"
								onchange="this.form.submit()">
								<option value="">category</option>
								<form:options itemValue="id" items="${categories}"
									itemLabel="name" />
							</form:select></li>
					</ul>
				</div>
					...
					<div class="col-xl-4 col-lg-6 col-md-6">
						<div class="box_grid wow">
							<figure class="block-reveal">
								...
								<a
									href="${pageContext.request.contextPath}/courses/${course.id}"><img
									src="${course.image}" class="img-fluid" alt=""></a>
								<div class="preview">
		...
		<div class="bg_color_1">
			<div class="container margin_60_35">
				<div class="row">
					<div class="col-md-4">
						<a href="#0" class="boxed_list"> <i class="pe-7s-help2"></i>
							<h4>Need Help? Contact us</h4>
							<p>Cum appareat maiestatis interpretaris et, et sit.</p>
						</a>
					</div>
					<div class="col-md-4">
						<a href="#0" class="boxed_list"> <i class="pe-7s-wallet"></i>
							<h4>Payments and Refunds</h4>
							<p>Qui ea nemore eruditi, magna prima possit eu mei.</p>
						</a>
					</div>
					<div class="col-md-4">
						<a href="#0" class="boxed_list"> <i class="pe-7s-note2"></i>
