				...
				<div class="row">
									...
									<ul>
										<c:forEach var="content" items="${course.contents}">
											<li><a
												...
												class="video">${content.title}</a><span>${content.period}</span></li>
										</c:forEach>
									</ul>
								</div>
					...
					<aside class="col-lg-4" id="sidebar">
						<div class="box_detail">
							<figure>
								<a
									href="https://www.youtube.com/watch?v=${course.contents[0].videoId}"
									class="video"> <i class="arrow_triangle-right"></i> <img
									src="${course.image}" alt="" class="img-fluid"> <span>View
										course preview</span>
								</a>
							</figure>
